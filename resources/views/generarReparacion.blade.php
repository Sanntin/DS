            ...
            <section>
                ...
                <article style="padding-right: 200px;padding-left: 200px;">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="dropdown" style="width: 100%;">
                                <select name="clientes" id="clientesListado" class="form-control" onchange="obtenerVehiculos()">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="dropdown" style="width: 100%;">
                                <select name="vehiculos" id="vehiculosListado" class="form-control" disabled>
                                    <option value='0' selected disabled hidden>-</option>
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col"><input type="number" style="width: 100%;"min="0"></div>
                    </div>
                    <div class="row">
                        <div class="col d-flex d-xl-flex align-items-center align-content-center align-self-center justify-content-xl-start align-items-xl-center">
                ...
                <article>
                    <div class="row">
                        <div class="col d-flex justify-content-center align-content-center"><a class="btn btn-primary d-flex justify-content-center align-self-center" role="button" data-toggle="tooltip" data-bs-tooltip="" style="width: 140px;" title="Agregar tarea" id="generarReparacion">Generar</a></div>
                        <div
