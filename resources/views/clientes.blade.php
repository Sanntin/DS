            ...
            <div class="col-lg-7">
                <div class="p-5">
                    <form class="user">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0"><button id="btnVolverAgregarCliente" class="btn btn-primary btn-block text-white btn-user" type="button" style="background-color: rgb(223,78,104);">Volver</button></div>
                            <div class="col-sm-6"><button id="btnGuardarAgregarCliente" class="btn btn-primary btn-block text-white btn-user" type="button">Agregar cliente</button></div>
                        </div>
                    </form>
                </div>
            </div>
